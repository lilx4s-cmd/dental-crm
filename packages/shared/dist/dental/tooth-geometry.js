...
function buildTooth(fdi, condition, mode = 'diagnosis') {
    ...
    if (condition === 'BONE_GRAFT') {
        below.push({
            ...
            fill: planTint(mode, exports.PALETTE.graft),
            stroke: mode === 'plan' ? exports.PALETTE.plannedStroke : exports.PALETTE.boneSpeck,
            strokeWidth: 0.9,
            opacity: 0.85,
        });
        ...
        for (const [cx, cy] of [[-9, 16], [7, 23], [-4, 32], [11, 38], [-12, 45], [4, 52], [-8, 60]]) {
            if (cy > spec.rootTip + 4)
                continue;
            below.push({ kind: 'circle', cx, cy, r: 1.8, fill: mode === 'plan' ? exports.PALETTE.plannedDeep : exports.PALETTE.boneSpeck });
        }
    }
    ...
    if (condition === 'SINUS_LIFT') {
        ...
        below.push({
            ...
            d: dome,
            fill: 'none',
            stroke: mode === 'plan' ? exports.PALETTE.plannedDeep : exports.PALETTE.sinus,
            strokeWidth: 1.8,
        });
    }
    ...
    if (condition === 'RECEDING_BONE') {
        ...
        const c = mode === 'plan' ? exports.PALETTE.plannedStroke : exports.PALETTE.boneLoss;
