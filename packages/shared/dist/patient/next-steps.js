...
exports.patientSteps = patientSteps;
exports.patientGuidance = patientGuidance;
const SAFETY_UNKNOWN = 'A clinician planning treatment reads this record. A blank here is an open question, not a "no".';
/**
...
function patientSteps(p) {
    ...
    if (p.treatmentPlanCount > 0 && p.pastAppointmentCount === 0) {
        steps.push({
            ...
            why: p.upcomingAppointmentCount > 0
...
const SEVERITY_RANK = { safety: 0, blocking: 1, admin: 2 };
function patientGuidance(snapshot) {
