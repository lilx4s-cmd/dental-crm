 ...
 */
export declare function passwordProblems(password: string, context?: PasswordContext): string[];
export declare function isAcceptablePassword(password: string, context?: PasswordContext): boolean;
/** The rules, phrased for a person, to show beside the field rather than after a rejection. */
export declare const PASSWORD_RULES: readonly string[];
