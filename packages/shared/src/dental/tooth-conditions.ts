...
export const DIAGNOSIS_CONDITIONS: ToothCondition[] = [
  'CARIES',
  'PLAQUE',
  'AMALGAM_FILLING',
  'COMPOSITE_FILLING',
...
export const PLAN_CONDITIONS: ToothCondition[] = [
  'EXTRACTION',
  'IMPLANT',
  'CROWN',
  'VENEER',
...
const KEYWORD_MAP: { match: string; condition: ToothCondition }[] = [
...
export function conditionFromText(...texts: (string | null | undefined)[]): ToothCondition | undefined {
